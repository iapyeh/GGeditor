...
with a section header and a colon followed by a block of indented text #2.
...
are also implicitly created anytime a new section starts #2.

Attributes:
    module_level_variable1 (int): Module level variables may be documented in
        either the ``Attributes`` section of the module docstring, or in an
        inline docstring immediately following the variable #2.
